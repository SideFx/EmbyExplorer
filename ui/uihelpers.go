...
func newMovieTable(content *unison.Panel, movieData []models.MovieData) {
	...
	header := unison.NewTableHeader[*models.MovieRow](models.MovieTable,
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[0].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[1].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[2].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[3].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[4].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[5].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[6].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[7].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[8].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[9].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[10].Caption, "", nil),
		unison.NewTableColumnHeader[*models.MovieRow](models.MovieTableDescription.Columns[11].Caption, "", nil),
	)
...
func newTVShowTable(content *unison.Panel, tvshowData []models.TVShowData) {
	...
	header := unison.NewTableHeader[*models.TVShowRow](models.TVShowTable,
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[0].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[1].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[2].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[3].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[4].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[5].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[6].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[7].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[8].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[9].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[10].Caption, "", nil),
		unison.NewTableColumnHeader[*models.TVShowRow](models.TVShowTableDescription.Columns[11].Caption, "", nil),
	)
	header.SetLayoutData(&unison.FlexLayoutData{
		HAlign: align.Fill,
		VAlign: align.Fill,
...
func newHomeVideoTable(content *unison.Panel, homevideoData []models.HomeVideoData) {
	...
	header := unison.NewTableHeader[*models.HomeVideoRow](models.HomeVideoTable,
		unison.NewTableColumnHeader[*models.HomeVideoRow](models.HomeVideoTableDescription.Columns[0].Caption, "", nil),
		unison.NewTableColumnHeader[*models.HomeVideoRow](models.HomeVideoTableDescription.Columns[1].Caption, "", nil),
		unison.NewTableColumnHeader[*models.HomeVideoRow](models.HomeVideoTableDescription.Columns[2].Caption, "", nil),
		unison.NewTableColumnHeader[*models.HomeVideoRow](models.HomeVideoTableDescription.Columns[3].Caption, "", nil),
		unison.NewTableColumnHeader[*models.HomeVideoRow](models.HomeVideoTableDescription.Columns[4].Caption, "", nil),
		unison.NewTableColumnHeader[*models.HomeVideoRow](models.HomeVideoTableDescription.Columns[5].Caption, "", nil),
		unison.NewTableColumnHeader[*models.HomeVideoRow](models.HomeVideoTableDescription.Columns[6].Caption, "", nil),
	)
	header.SetLayoutData(&unison.FlexLayoutData{
		HAlign: align.Fill,
		VAlign: align.Fill,
